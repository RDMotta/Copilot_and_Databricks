...
### Módulo 7 — SQL Warehouse Serverless (Conta Free) (40 min)
...
### 🧪 Trilha 4 — SQL Warehouse Serverless (Conta Free)
> Execute um ETL completo usando apenas SQL Warehouse serverless 2X-Small. **4 etapas — Módulo 7.**
...
<p>
  ...
  &nbsp;
  <a href="https://github.com/OWNER/REPO/actions/workflows/start-track4.yml">
    <img src="https://img.shields.io/badge/🧪_Iniciar_Trilha_4-SQL_Serverless_Free-fb8500?style=for-the-badge" alt="Iniciar Trilha 4"/>
  </a>
</p>
